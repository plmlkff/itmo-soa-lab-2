...
import ru.itmo.product.repository.PersonRepository;
...
public class ProductServiceImpl implements ProductService {
    ...
    public Product createProduct(ProductDto productDto) {
        if (!personRepository.existsById(productDto.owner().id())){
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Person with provided id doesn't exist!");
        }
